                ...
                <section className="bg-roufi-green text-white py-16 relative overflow-hidden">
                    <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between">
                        ...
                        <div className="md:w-1/2 flex justify-center md:justify-end">
                            <img
                                src="/assets/Pain-Management-Laser-Therapy.png"
                ...
                <section className="py-16 bg-white">
                    <div className="max-w-5xl mx-auto px-4 md:px-8">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-4xl md:text-5xl font-bold text-roufi-red">Pain Management</h2>
                        </div>

                        <p className="text-lg mb-8">
                        Just like people, pets can suffer lingering effects and discomfort from an injury or a surgical procedure. Buffalo Veterinary Clinic takes treating pain seriously and offers several options to help pets feel better, including medication and laser therapy. We’ll develop a pain management program that’s customized for your pet’s condition and needs.</p>
                        <p className="text-lg mb-12 font-medium">
                        Physical therapy can be especially effective as it is proven to speed recovery and improve strength and mobility. By using rehabilitation therapy and offering instruction on at-home techniques and other pain management options, your pet will benefit from our expert care.  </p>
                        {/* <p className="text-lg mb-12 font-medium">
