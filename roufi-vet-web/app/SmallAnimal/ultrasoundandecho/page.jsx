                ...
                <section className="py-16 bg-white">
                    <div className="max-w-5xl mx-auto px-4 md:px-8">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-4xl md:text-5xl font-bold text-roufi-red">Ultrasound and Echocardiograms</h2>
                        </div>
                        ...
                        Using high-frequency sound waves, ultrasound is used to create real-time images of your pet’s internal organs and systems. Ultrasounds are generally non-invasive, using a hand-held scanner or probe to image your pet’s body and ultrasound gel to improve contact and get a more detailed picture. Light sedation may be needed to help the pet relax, as ultrasounds do require the patient to remain still.</p>
                        {/* <p className="text-lg mb-12 font-medium">
...
export default ultrasoundandecho;
