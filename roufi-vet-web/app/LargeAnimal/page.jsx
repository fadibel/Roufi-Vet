        ...
        <div className="min-h-screen mt-20 bg-white">
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="max-w-6xl mx-auto">
                    ...
                    RoufiVet Veterinary Clinic is proud to offer veterinary services for horses, cattle, and livestock. We know that getting these animals to the vet can be difficult, time consuming, and in some cases impossible, which is why we offer on-site farmhouse calls so your animals can get the care they need.                    </p>
